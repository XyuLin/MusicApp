...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/appMusic/index.php/Admin/Admin/add.html">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="username" size="50" placeholder="请输入新账号" data-validate="required:请输入新账号,length#>=5:新账号不能小于6位" />
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="password" class="input w50" name="cpassword" size="50" placeholder="请输入新密码" data-validate="required:请输入新密码,length#>=5:新密码不能小于5位" />
        </div>
      </div>
