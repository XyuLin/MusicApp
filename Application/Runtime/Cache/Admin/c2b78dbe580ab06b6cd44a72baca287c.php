...
<div class="panel admin-panel">
  <div class="body-content">
    <form method="post" class="form-x" action="/appmusic/index.php/Admin/Musical/edit/id/19.html" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo ($info['musical_name']); ?>"  name="musical_name" data-validate="required:请输入乐器的名称" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          ...
          <textarea id="musical_sm" name="musical_sm"><?php echo ($info['musical_sm']); ?></textarea>
          <div class="tips"></div>
        </div>
      </div>
