...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/appmusic/index.php/Admin/Attribute/edit/id/2.html&amp;type_id=1" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo ($info['attr_name']); ?>" name="attr_name" data-validate="required:分类姓名" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <select name="type_id" class="input w50">
              <?php if(is_array($type_info)): foreach($type_info as $key=>$v): if($v['id'] == $info['type_id']): ?>>
                    <option selected ="selected" value="<?php echo ($v['id']); ?>"><?php echo ($v['type_name']); ?></option><?php endif; ?>
                <!--<option value="<?php echo ($v['id']); ?>"><?php echo ($v['type_name']); ?></option>--><?php endforeach; endif; ?>
          </select>
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea name="attr_option_values"><?php echo $info['attr_option_values']; ?></textarea>
          <div class="tips"></div>
        </div>
      </div>
