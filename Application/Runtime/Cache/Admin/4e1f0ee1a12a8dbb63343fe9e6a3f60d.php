...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>注册</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="/appMusic/index.php/Admin/User/add.html" enctype="multipart/form-data">
...
<!-- 
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="office_address" data-validate="required:请输入地址" />
          <div class="tips"></div>
        </div>
      </div> -->
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="home_address" data-validate="required:请输入地址" />
          <div class="tips"></div>
        </div>
      </div>
...
<!--       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="education_age" data-validate="required:请输入电话" />
          <div class="tips"></div>
        </div>
      </div> -->
<!-- 
