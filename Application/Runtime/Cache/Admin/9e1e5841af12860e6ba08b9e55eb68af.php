...
<form method="post" action="" id="listform">
  <div class="panel-head"><strong class="icon-reorder"> 分类列表</strong> <a href="" style="float:right; display:none;">添加分类</a></div>
  ...
  <table class="table table-hover text-center">
    ...
    <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
        ...
        <td><?php echo str_repeat('-',8*$v['level']).$v['type_name']; ?></td>
        <td>
          <div class="button-group">
            <a class="button border-main" href="<?php echo U('Attribute/lst?id='.$v['id']);?>"><span class="icon-edit"></span> 属性管理</a>
            <a class="button border-main" href="<?php echo U('edit?id='.$v['id']);?>"><span class="icon-edit"></span> 修改类型</a>
