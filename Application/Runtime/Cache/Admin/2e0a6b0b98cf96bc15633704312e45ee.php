...
<form method="post" action="" id="listform">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="<?php echo U('Admin/add');?>"> 添加管理员</a> </li>
        <li>搜索：</li>
        <li>
    ...
    <table class="table table-hover text-center">
      <tr>
        ...
        <th width="25%">操作</th>
          ...
          <?php if(is_array($info)): foreach($info as $key=>$v1): ?><tr>
          <td style="text-align:left; padding-left:20px;"><?php echo $v1['id'];?></td>
          <td><?php echo $v1['username'];?></td>
          <td><?php echo $v1['addtime'];?></td>
          <td>
              <div class="button-group"> <a class="button border-main" href="<?php echo U('edit?id='.$v1['id']);?>"><span class="icon-edit"></span> 修改</a>
                 <a class="button border-red" href="<?php echo U('del?id='.$v1['id']);?>" onclick=" return confirm('请确认删除当前账号！！！');"><span class="icon-trash-o"></span> 删除</a>
              </div>
          </td>
