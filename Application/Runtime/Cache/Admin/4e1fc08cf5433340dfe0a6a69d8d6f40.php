...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/appmusic/index.php/Admin/Brand/edit/id/1.html" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo ($info['brand_name']); ?>" name="brand_name" data-validate="required:分类姓名" />
          <div class="tips"></div>
        </div>
      </div>
