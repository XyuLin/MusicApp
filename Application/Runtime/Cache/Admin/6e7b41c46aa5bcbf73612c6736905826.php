...
<div class="panel admin-panel">
  <div class="body-content">
    <form method="post" class="form-x" action="/appmusic/index.php/Admin/musical/ajaxGetbrand" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <select name="brand_id" id="" class="input w50">
            <option value="">请选择...</option>
            <?php if(is_array($info)): foreach($info as $key=>$v): ?><option value="<?php echo ($v['id']); ?>"><?php echo $v['brand_name'];?></option><?php endforeach; endif; ?>
          </select>
          <div class="tips"></div>
        </div>
      </div>
...
<script type="text/javascript">
    ...
    $(function(){
        $.ajax({
            ...
            success: function (data) {
                var select = "";
                select +='<select name="brand_id"  value="" class="selectpicker"><option name="" value="">请选择...</option>';
                $(data).each(function (k, v) {
