...
<form method="post" action="" id="listform">
  <div class="panel-head"><strong class="icon-reorder"> 属性列表</strong> <a href="" style="float:right; display:none;">属性列表</a></div>
  <div class="padding border-bottom">
    <ul class="search" style="padding-left:10px;">
      <li> <a class="button border-main icon-plus-square-o" href="<?php echo U('add');?>"> 添加属性</a> </li>
      <li>搜索：</li>
      <li>
  ...
  <table class="table table-hover text-center">
    ...
    <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
        ...
        <td><?php echo $v['attr_sel'];?></td>
        <td>
          <div class="button-group">
            <a class="button border-main" href="<?php echo U('edit?id='.$v['id']).'&type_id='.$v['type_id'];?>"><span class="icon-edit"></span> 修改属性</a>
            <a class="button border-red" href="<?php echo U('del?id='.$v['id'].'&type_id='.$v['type_id']);?>" onclick=" return confirm('请确认删除当前账号！！！');"><span class="icon-trash-o"></span> 删除</a>
          </div>
        </td>
