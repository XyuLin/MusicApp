        ...
        <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                ...
                <td>
                    <div class="button-group">
                        <a class="button border-red" href="<?php echo U('del_com_teacher?id='.$v['id']);?>" onclick=" return confirm('请确认删除此评论！！！');"><span class="icon-trash-o"></span> 删除</a>
                    </div>
                </td>
